...
let replaceSymbolWithNumber = (~str=?, ~symbol=?, ()) => fakers.replaceSymbolWithNumber(nullable(str), nullable(symbol));
...
[@bs.module "faker"] [@bs.scope "helpers"]
external shuffle : Js.Nullable.t(Js.Array.t('a)) => Js.Array.t('a) = "shuffle";
let shuffle = (~o=?, ()) => shuffle(nullable(o));

[@bs.module "faker"] [@bs.scope "helpers"]
external mustache : (Js.Nullable.t(string), Js.Nullable.t(Js.Dict.t('a))) => string = "mustache";
