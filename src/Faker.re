...
module Internet = {
  ...
  type t = {
    ...
    avatar: unit => string,
    email: (Js.Nullable.t(string), Js.Nullable.t(string), Js.Nullable.t(string)) => string,
    ...
    mac: unit => string,
    password: (
      Js.Nullable.t(int), Js.Nullable.t(bool), Js.Nullable.t(Js.Re.t), Js.Nullable.t(string)
    ) => string,
  };
  ...
  let avatar = () => avatar(fakers, ());
  let email = (~firstName=?, ~lastName=?, ~provider=?, ()) => email(fakers, nullable(firstName), nullable(lastName), nullable(provider));
  let exampleEmail = (~firstName=?, ~lastName=?, ()) => exampleEmail(fakers, nullable(firstName), nullable(lastName));
  ...
  let password = (
    ...
    fakers, nullable(length), nullable(memorable), nullable(pattern), nullable(prefix)
  );
};
